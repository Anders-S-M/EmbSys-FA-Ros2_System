...
// ==============================================================
`timescale 1ns/1ps
module inference_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER         = 14'h0008,
    ADDR_ISR         = 14'h000c,
    ADDR_AP_RETURN_0 = 14'h0010,
    ADDR_IN_R_BASE   = 14'h2000,
    ADDR_IN_R_HIGH   = 14'h3fff,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
assign RVALID  = (rstate == RDDATA) & !int_in_r_read;
...
module inference_control_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
