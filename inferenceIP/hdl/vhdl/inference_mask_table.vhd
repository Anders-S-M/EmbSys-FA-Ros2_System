...
entity inference_mask_table_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of inference_mask_table_rom is 
...
entity inference_mask_table is
    generic (
...
architecture arch of inference_mask_table is
    component inference_mask_table_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    inference_mask_table_rom_U :  component inference_mask_table_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
